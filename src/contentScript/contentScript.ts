...
const addNote = (color) => {
    ...
    if (selection && !selection.isCollapsed) {
        ...
        const buttonBorderStyle: string = "1px solid #3182ce"; // Blue border
        const buttonBorderRadius: string = "10px"; // Rounded corners
        const buttonBackgroundColor: string = "transparent"; // Transparent background
        const buttonTextColor: string = "#3182ce"; // Blue text color
        const buttonCursor: string = "pointer"; // Pointer cursor
        const buttonTransition: string = "background-color 0.3s, color 0.3s"; // Smooth transition

        const buttonHoverBackgroundColor: string = "#3182ce"; // Blue background on hover
        const buttonHoverTextColor: string = "white"; // White text color on hover
